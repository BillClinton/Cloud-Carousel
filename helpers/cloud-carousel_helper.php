...
if ( ! function_exists('cloud_carousel'))
{
	function cloud_carousel($items=array(), $config=array(), $css_id)
	{
        ...
        $CI->load->config('cloud_carousel',true,false); // true to avoid naming collisions, false to not suppress errors
...
CAROUSEL;
        ...
        <input id="carousel-left-but"  type="button" value="Left" />
        <input id="carousel-right-but" type="button" value="Right" />
